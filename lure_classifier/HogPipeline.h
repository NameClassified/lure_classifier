#ifndef UUID140261402547144
#define UUID140261402547144


    #ifndef UUID140261402547200
#define UUID140261402547200
 ...
 * ---------
 *  - Resize(from=(640, 480), to=(40, 30), pixformat=gray)
 *  > HOG(block_size=8, bins=9, cell_size=3)
 */
class HogPipeline {
    public:
...
uint16_t latencyInMillis() {
    ...
    for (uint16_t y = 0; y < 30; y++) {
        const size_t sourceOffset = round(y * dy) * 640;
